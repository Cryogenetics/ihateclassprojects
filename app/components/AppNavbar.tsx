    ...
    >
        ...
        <NavbarContent justify={"center"}>
            <NavbarItem>
                ...
                <NavbarItem><Link color="foreground" href={"/authed/employees"} className="font-medium">Employees</Link></NavbarItem>
                <NavbarItem><Link color="foreground" href={"/authed/shops"} className="font-medium">Shops</Link></NavbarItem>
                <NavbarItem><Link color="foreground" href={"/authed/vehicles"} className="font-medium">Vehicles</Link></NavbarItem>
